...
def map_item2id(items, vocab, max_len, non_word=0, lower=False):
    """
    mapping word/pos to ids
    :param items: list
    :param vocab: vocabulary
    :param max_len: int，maximum length of list
    :param non_word: OOV word, default 0
    :param lower: bool
    :return: np.array, dtype=int32,shape=[max_len,]
    """
    assert type(non_word) == int
    arr = np.zeros((max_len,), dtype='int32')
    # trancate max_len length of items
